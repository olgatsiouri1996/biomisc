...
import pandas as pd
# input arguments
ap = argparse.ArgumentParser(description="convert each row of a tabular file with the fasta headers and sequences in each row in single-fasta files with trimmed sequences")
