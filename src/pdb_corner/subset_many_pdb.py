...
ap.add_argument("-pdb", "--pdbdir", required=False, type=str, default='.', help=" directory containing the input pdb files(relative path). Defaults to the current directory")
...
ap.add_argument("-out", "--outdir", required=False, type=str, default='.', help=" directory to save the output pdb files(relative path). Defaults to the current directory")
...
# set working directory
	os.chdir(os.path.realpath(args['pdbdir']))
# import pdb
	parser = PDBParser()
