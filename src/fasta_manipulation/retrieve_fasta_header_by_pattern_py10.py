...
ap.add_argument("-headers", "--headers", required=True, help="1 or 2-column tab seperated txt file to save the output fasta identifiers or full fasta headers respectively")
