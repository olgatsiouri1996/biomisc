...
ap.add_argument("-pro", "--program", type=int, default=1, required=False, help="program to choose: 1. export the sequences of fasta2 that have the same identifiers as fasta1, 2. export the sequences of fasta1 that don't have the same identifiers as fasta2")
