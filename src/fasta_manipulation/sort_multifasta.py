...
ap.add_argument("-in", "--input", required=True, help="input multi-fasta file(fasta descriptions tab seperated from fasta identifiers)")
ap.add_argument("-ids", "--ids", required=True, help="file with sorted fasta identifiers to retrieve the output fasta sequences")
