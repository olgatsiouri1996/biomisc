...
ap.add_argument("-in","--input", required=True, help="input multi-fasta file(all fasta records should either have no fasta description or all of them should have fasta description)")
