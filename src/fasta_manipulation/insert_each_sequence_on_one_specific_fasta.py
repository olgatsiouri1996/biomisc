...
# input parameters
ap = argparse.ArgumentParser(description="insert each sequence at specific positions in one specific sequence in a multi-fasta file")
ap.add_argument("-in", "--input", required=True, help="input multi-fasta file")
ap.add_argument("-is", "--insert", required=True, help="input multi-fasta file with the sequences to insert")
