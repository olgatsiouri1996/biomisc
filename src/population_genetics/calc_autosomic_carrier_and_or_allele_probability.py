...
ap.add_argument("-out", "--output", required=True, help="2 or 3-column tab-seperated output txt file with the probability of containing an allele and/or being heterozygous and the input column")
args = vars(ap.parse_args())
# convert 1-column txt file to list
with open(args['input'],'r') as f:
    A = f.readlines()
A = [float(x.strip()) for x in A]
# choose and output based 
